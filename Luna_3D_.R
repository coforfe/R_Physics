...
# Coordenadas cartesianas en una esfera de radio unitario
x <- cos(altura_rad) * sin(acimut_rad)
y <- cos(altura_rad) * cos(acimut_rad)
z <- sin(altura_rad)
...
# --- 6. Representar la trayectoria de la Luna en 3D ---

# Crear el gráfico 3D interactivo
fig <- plot_ly(trayectoria_luna, x = ~x, y = ~y, z = ~z, type = 'scatter3d', mode = 'lines+markers',
